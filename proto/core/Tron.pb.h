...
typedef struct _protocol_Permission {
    ...
    int32_t id; /* Owner id=0, Witness id=1, Active id start by 2 */
    pb_callback_t permission_name;
    int64_t threshold;
    int32_t parent_id;
    pb_byte_t operations[32]; /* 1 bit 1 contract */
...
#define protocol_Transaction_Contract_type_ENUMTYPE protocol_Transaction_Contract_ContractType

#define protocol_Transaction_Result_ret_ENUMTYPE protocol_Transaction_Result_code
#define protocol_Transaction_Result_contractRet_ENUMTYPE protocol_Transaction_Result_contractResult



#define protocol_Permission_type_ENUMTYPE protocol_Permission_PermissionType
...
#define PROTOCOL_CORE_TRON_PB_H_MAX_SIZE         protocol_Key_size
